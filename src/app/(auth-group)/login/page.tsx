    ...
    <div className="max-w-[480px] mx-auto w-full space-y-12 animate-in fade-in slide-in-from-right-10 duration-700">
      <div className="space-y-4">
        ...
        <p className="text-gray-500 font-medium text-lg">
          Please enter your credentials to access your analytical workspace.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Link
                href="#"
                className="text-[10px] font-black text-primary hover:opacity-70 uppercase tracking-widest border-b-2 border-primary/20"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <label
              htmlFor="remember"
              className="text-sm font-bold text-gray-500 cursor-pointer uppercase tracking-widest text-[9px]"
            >
        ...
        <div className="text-center text-[10px] font-black text-gray-400 uppercase tracking-widest">
          ...
          <Link
            href="/signup"
            className="text-primary hover:opacity-70 border-b-2 border-primary/20 pb-0.5 ml-2 transition-all"
          >
            Create Account
          </Link>
        </div>
